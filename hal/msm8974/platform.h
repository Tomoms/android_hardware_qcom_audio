...
enum {
    ...
    SND_DEVICE_OUT_HANDSET = SND_DEVICE_OUT_BEGIN, // 1
    ...
    SND_DEVICE_OUT_HEADPHONES_HIFI_FILTER, // 11
    ...
    SND_DEVICE_OUT_SPEAKER_AND_LINE, // 21
    ...
    SND_DEVICE_OUT_SPEAKER_DISPLAY_PORT1_AND_HAPTICS, // 41
    ...
    SND_DEVICE_OUT_SPEAKER_BT_SCO_SWB_AND_HAPTICS, // 61
    ...
    SND_DEVICE_OUT_SPEAKER_SAFE_AND_USB_HEADSET, // 81
    ...
    SND_DEVICE_IN_HANDSET_MIC  = SND_DEVICE_IN_BEGIN, // 124
    ...
    SND_DEVICE_IN_HANDSET_MIC_AEC_NS, // 134
    ...
    SND_DEVICE_IN_HEADSET_MIC_AEC, // 164
    ...
    SND_DEVICE_IN_VOICE_TTY_HCO_USB_MIC, // 194
    ...
    SND_DEVICE_IN_USB_HEADSET_MIC_AEC, // 204
